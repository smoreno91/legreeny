<?php 
class EM_Em0141settings_Model_Config_Font
{
	const CACHE_KEY = 'EMBASETHEME_GOOGLE_FONTS';
	const CACHE_LIFETIME = 86400;
    
    /*protected $googlefonts_url = 'https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=AIzaSyCZ6wqklkyJFXWvoxvA5Zv0SGzHTd6JbbI';*/
    ...
    public function toOptionArray()
    {
        ...
        $googlefonts_url = 'https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key='.Mage::helper('themeframework/settings')->getFonts_GoogleFontKey('AIzaSyCZ6wqklkyJFXWvoxvA5Zv0SGzHTd6JbbI');
		if (!($fonts = $cache->load(self::CACHE_KEY))) {			
			$ch = curl_init($googlefonts_url);
