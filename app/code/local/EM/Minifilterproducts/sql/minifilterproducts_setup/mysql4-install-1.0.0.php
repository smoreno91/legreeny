...
if(!$installer->getAttributeId('catalog_product', 'em_featured')){
...
if(!$installer->getAttributeId('catalog_product', 'em_deal')){
...
if(!$installer->getAttributeId('catalog_product', 'em_hot')){
