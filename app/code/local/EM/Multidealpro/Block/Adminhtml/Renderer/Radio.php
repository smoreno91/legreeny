<?php
class EM_Multidealpro_Block_Adminhtml_Renderer_Radio extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    public function render(Varien_Object $row)
	{
        ...
        $html .= 'value="' . $row->getId() . '" onclick="radioclick(this)" class="radio"' . $checked . '/>';
        return $html;
    }
