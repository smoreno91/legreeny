 ...
 */
class EM_Multidealpro_Block_Toolbar extends Mage_Core_Block_Template
{
    /**
     * Products collection
     *
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('em_multidealpro/all_deals/toolbar.phtml');
    }
    ...
    public function setCollection($collection)
    {
        ...
        if ($limit) {
            $this->_collection->setPageSize(Mage::helper("multidealpro")->getMainDeal_ColumnCount()*Mage::helper("multidealpro")->getMainDeal_RowCount());
        }
    ...
    public function getFirstNum()
    {
		...
		$pageSize = Mage::helper("multidealpro")->getMainDeal_ColumnCount()*Mage::helper("multidealpro")->getMainDeal_RowCount();
    ...
    public function getLastNum()
    {
       ...
       // return $collection->getPageSize()*($collection->getCurPage()-1)+$collection->count();
        return $pageSize*($collection->getCurPage()-1)+$collection->count();
    }
    ...
    {
        $pagerBlock = $this->getChild('multideal_list_toolbar_pager');
        ...
        if ($pagerBlock instanceof Varien_Object) {
            ...
            $pagerBlock->setUseContainer(false)
                ...
                ->setLimit(Mage::helper("multidealpro")->getMainDeal_ColumnCount()*Mage::helper("multidealpro")->getMainDeal_RowCount())
