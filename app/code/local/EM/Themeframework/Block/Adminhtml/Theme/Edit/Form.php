 ...
 */
class EM_Themeframework_Block_Adminhtml_Theme_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    {        
        $form = new Varien_Data_Form(array(
                'id' => 'edit_form',
                'class' => 'em_settings',
                'action' => $this->getUrl('*/*/save', array('theme_id' => $this->getRequest()->getParam('theme_id'))),
                'method' => 'post',
