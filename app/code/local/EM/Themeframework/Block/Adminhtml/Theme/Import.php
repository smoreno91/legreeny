...
class EM_Themeframework_Block_Adminhtml_Theme_Import extends  Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        return Mage::helper('themeframework')->__("Import data %s", $this->escapeHtml(Mage::registry('theme_data')->getThemeName()));
    }
