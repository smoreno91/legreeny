...
class EM_Themeframework_Model_Resource_Megamenupro_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
    ...
    protected function _construct()
    {
        ...
        $this->_init('themeframework/megamenupro');
    }

    /**
     * Returns pairs megamenupro_id - identifier
     *
     * @return array
     */
    public function toOptionArray()
    {
        return $this->_toOptionArray('megamenupro_id', 'identifier');
    }
