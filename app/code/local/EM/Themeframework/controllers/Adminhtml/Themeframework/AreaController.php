...
class EM_Themeframework_Adminhtml_Themeframework_AreaController extends Mage_Adminhtml_Controller_Action
{
	protected function _initAction()
	{
		// load layout, set active menu and breadcrumbs
		$this->loadLayout()
			->_setActiveMenu('emthemes/area')
	...
	function previewBlockAction() {
		$this->getResponse()->setRedirect(Mage::getModel('core/url')->getDirectUrl('themeframework/area/previewBlock/key/'.Mage::getSingleton('adminhtml/url')->getSecretKey('cms_block', 'edit').'/fblock_key/'.Mage::getSingleton('adminhtml/url')->getSecretKey('fblock', 'edit')));
	}
}