 ...
 */
class MF_Flexibleblock_Block_Adminhtml_Fblock_Edit_Tab_Conditions
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    protected function _prepareForm()
    {
        ...
        $conditionsArr = unserialize($fblock->getConditions());

        if (!empty($conditionsArr) && is_array($conditionsArr)) {
            $model->getConditions()->loadArray($conditionsArr);
        }
        ...
        $fieldset->addField('note', 'note', array(
          'text'     => Mage::helper('catalogrule')->__('This field only works if "Products" layout handle in General Information Tab selected'),
